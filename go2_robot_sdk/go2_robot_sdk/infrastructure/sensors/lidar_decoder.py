...
_decoder_instance: LidarDecoder = None


def get_voxel_decoder() -> LidarDecoder:
    """
    Get or create a cached LidarDecoder singleton.

    Returns:
        Shared LidarDecoder instance (lazy-initialized on first call)
    """
    global _decoder_instance
    if _decoder_instance is None:
        _decoder_instance = LidarDecoder()
